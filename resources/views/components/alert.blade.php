@if($errors->any())
 <div class="flex items-center justify-center">
     <div class="w-1/4 px-4 py-3 my-4 text-teal-900 bg-teal-100 border-t-4 border-teal-500 rounded-b shadow-md alert alert-danger" role="alert">
        <div class="flex">
          ...
          <div>
            <p class="font-bold">Erro encontrado!</p>
