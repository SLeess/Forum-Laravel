<div>
    ...
    <nav id="navbar">
        <div class="px-2 mx-auto max-w-7xl sm:px-6 lg:px-8" style="filter: blur(0px);">
            <div class="relative flex items-center justify-between h-16">
                ...
                @endauth
                @guest
                    <x-responsive-nav-link :href="route('login')" class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                        {{ __('Entrar') }}
                    </x-responsive-nav-link>

                    @if (Route::has('register'))
                        <x-responsive-nav-link :href="route('register')" class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                            {{ __('Registre-se') }}
                        </x-responsive-nav-link>
                    @endif
                @endguest
        ...
        <div class="hidden sm:hidden" id="mobile-menu">
          <div class="px-4 pt-1 pb-3 mb-2 space-y-1">
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
